...
本文档提供可在 **加解密 / 自动识别** 页面直接粘贴的样例。密码吧入门路线见 **[CTF-CLASSICAL.md](./CTF-CLASSICAL.md)**。
...
| 2 | 打开 **加解密**（默认首页），左侧选「密码吧入门」或搜索算法 |
| 3 | 粘贴下方密文，或到 **自动识别**（实验）试样例 |
...
| 文档 | 内容 |
|------|------|
| [IDENTIFY-TECH.md](./IDENTIFY-TECH.md) | 识别评分、自然度算法、LLM 重排、容易出现的误区 |
